...
//amb background dif：light
//改变背景颜色
function outputcolor(amb, dif) {
    //for (i = 0, l = scene.meshes.length; i < l; i++) {
    //    scene.meshes[i].material.ambient.set(amb);
    //}



    //for (i = 0, l = scene.meshes.length; i < l; i++) {
    //    scene.meshes[i].material.diffuse.set(dif);
    //}
    
    LIGHT.proxy.ambient.set(amb);
    LIGHT.proxy.ambientHex = LIGHT.proxy.ambient.format();
    LIGHT.proxy.diffuse.set(dif);
